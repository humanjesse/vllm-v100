...
class RayExecutorV2(MultiprocExecutor):
    ...
    def _init_executor(self) -> None:
        ...
        # MultiprocExecutor.collective_rpc references self.shutdown_event (set by
        # MultiprocExecutor._init_executor which we override). Initialize it here
        # so inherited collective_rpc works.  PR #36836 upstream bug.
